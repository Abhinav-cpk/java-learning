...
public class challlcm {
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        challlcm obj = new challlcm();
        int num1,num2;
        while(true){
            ...
            if(input.hasNextInt()){
                ...
                if(input.hasNextInt()) {
                    ...
                    int result = obj.lcm(num1,num2);
                    System.out.println("The LCM of the given two numbers is: "  + result);

                    System.out.print("Do you want to calculate another LCM? (yes/no): ");
